...
const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const [deliverySettings, setDeliverySettings] = useState({
    ...
    deliveryAreas: [
      { name: 'الفروانية', price: 2.000, isActive: true },
      { name: 'حولي', price: 2.500, isActive: true },
      { name: 'الأحمدي', price: 3.000, isActive: true },
      { name: 'الجهراء', price: 3.500, isActive: true },
      { name: 'مبارك الكبير', price: 2.500, isActive: true },
      { name: 'العاصمة', price: 2.000, isActive: true }
    ],
    deliveryTimeSlots: [
